<div class="modal fade" id="addPlataforma" tabindex="-1" role="dialog" aria-labelledby="addIdioma" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form class="create_platform" action="{{route('platforms_store')}}" method="POST" enctype="multipart/form-data" id="createService">
